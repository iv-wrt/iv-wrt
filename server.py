...
def root():
    ...
    <!--\
    <br><a href=/call/upnpc/%20-m%20172.30.254.1%20-a%2010.254.254.1%2080%2080%20TCP>Poke a hole via upnp</a></>\
    -->\
    <br><a href=/csrf/open/80>CSRF:Open Port 80 to the WAN</a></>\
            ...
            <br><xmp>To check for an IGD use "upnpc -m <iface> -s" and to open port 80 to the WAN use "upnpc -m <iface> -a <ip> <port> <external_port> (TCP|UDP)." For our purposes that\'ll look like: upnpc -m 172.30.254.1 -a 10.254.254.1 80 80 TCP</xmp></br>\
