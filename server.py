...
def hello_world():
    return '<br><a href=/csrf/open/80>CSRF:Open Port 80 to the WAN</a></>\
            ...
            <br><xmp>To check for an IGD use "upnpc -m <iface> -s" and to open port 80 to the WAN use "upnpc -m <iface> -a <ip> <port> <external_port> (TCP|UDP)." For our purposes that\'ll look like: upnpc -m br0 172.30.254.1 80 80 TCP</xmp></br>\
            '
